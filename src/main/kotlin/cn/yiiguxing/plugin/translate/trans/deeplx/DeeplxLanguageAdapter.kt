...
/**
 * Language adapter for DeepLx Translator.
 */
object DeeplxLanguageAdapter : BaseLanguageAdapter() {
...
/**
 * Language code for DeepLx Translator.
 */
val Lang.deeplxLanguageCode: String
    get() = DeeplxLanguageAdapter.getLanguageCode(this)
