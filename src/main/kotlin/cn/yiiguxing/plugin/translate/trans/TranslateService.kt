...
class TranslateService private constructor() : Disposable {
    ...
    fun getCache(text: String, srcLang: Lang, targetLang: Lang): Translation? {
        checkThread()
        return cacheService.getMemoryCache(text, srcLang, targetLang, translator.id, translator.translationCacheToken)
    }
    ...
    fun translate(
        ...
        checkThread()
        cacheService.getMemoryCache(text, srcLang, targetLang, translator.id, translator.translationCacheToken)?.let {
            ...
            try {
                with(translator) {
                    translate(text, srcLang, targetLang).let { translation ->
                        ...
                        cacheService.putMemoryCache(text, srcLang, targetLang, id, translationCacheToken, translation)
