 ...
 */
object DeeplxSupportedLanguages : SupportedLanguages {
    /**
 ...
 */
val Lang.deeplxLanguageCodeForSource: String
    get() = when (this) {
        Lang.PORTUGUESE -> "PT"
 ...
 */
val Lang.deeplxLanguageCodeForTarget: String
    get() = when (this) {
 ...
 */
fun Lang.Companion.fromDeeplxLanguageCode(code: String): Lang {
